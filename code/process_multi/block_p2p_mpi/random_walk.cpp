...
// Given a Min, Max, and random walker W, make walker W take S random walks which means S is an arbitrary length to the right. If the process goes out of bounds, it wraps back around. W can only move one unit to the right or left at a time.

//cannot understand this process
