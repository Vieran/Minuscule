...
/*
//return the number of seconds that has elapsed since 1970.1.1 to the present as a double number
MPI_Wtime() //use subtraction to get the intervals
*/
...
int main(int argc, char** argv) {
  ...
  int num_trials = atoi(argv[2]); //receive the number of trials to try
